...
public class HistorialPlacesFragment extends Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView t1 = (TextView)view.findViewById(R.id.lahore_fort_textView);
        ...
        TextView t2 = (TextView)view.findViewById(R.id.cypress_tomb_textView);
        ...
        TextView t3 = (TextView)view.findViewById(R.id.khan_e_jahan_tomb_textView);
        ...
        TextView t5 = (TextView)view.findViewById(R.id.Mosque_Mariyum_textView);
        ...
        TextView t6 = (TextView)view.findViewById(R.id.haveli_textView);
