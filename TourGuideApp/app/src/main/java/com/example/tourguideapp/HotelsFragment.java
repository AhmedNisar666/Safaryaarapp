...
public class HotelsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView t1 = (TextView)view.findViewById(R.id.luxus_hotel_textView);
        ...
        TextView t2 = (TextView)view.findViewById(R.id.heritage_hotel_textView);
        ...
        TextView t3 = (TextView)view.findViewById(R.id.pc_textView);
        ...
        TextView t4 = (TextView)view.findViewById(R.id.Nishat_hotel_textView);
        ...
        TextView t5 = (TextView)view.findViewById(R.id.Avari_hotel_textView);
