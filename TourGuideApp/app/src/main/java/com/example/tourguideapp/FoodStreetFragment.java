...
public class FoodStreetFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView t1 = (TextView)view.findViewById(R.id.haleem_textView);
        ...
        TextView t2 = (TextView)view.findViewById(R.id.seekh_kebab_textView);
        ...
        TextView t3 = (TextView)view.findViewById(R.id.biryani_textView);
        ...
        TextView t4 = (TextView)view.findViewById(R.id.halwa_puri_textView);
        ...
        TextView t6 = (TextView)view.findViewById(R.id.Chanay_textView);
        ...
        TextView t7 = (TextView)view.findViewById(R.id.karahi_textView);
