...
public class ShoppingPlacesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView t1 = (TextView)view.findViewById(R.id.emporium_mall_textView);
        ...
        TextView t2 = (TextView)view.findViewById(R.id.Fortress_sqaure_mall_textView);
        ...
        TextView t3 = (TextView)view.findViewById(R.id.mall_of_Lahore_textView);
        ...
        TextView t4 = (TextView)view.findViewById(R.id.amanah_Mall_textView);
        ...
        TextView t5 = (TextView)view.findViewById(R.id.packages_Mall_textView);
